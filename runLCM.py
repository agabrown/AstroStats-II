...
Here the 1/x prior on the variance hyper-parameter tau=1/sigma^2_M is used.
"""
...
def runMCMCmodel(args):
  ...
  lumCalModel=L.UniformSpaceDensityGaussianLF(S,float(surveyParams[1]), float(surveyParams[2]),
...
def parseCommandLineArguments():
  ...
  parser.add_argument("--priors", dest="priorsString", nargs=4,
      help="""White-space-separated list of prior ranges of luminosity distribution parameters:
              ...
              (3) shape parameter for Inverse-Gamma prior on the inverse variance of the absolute
              magnitudes,
              (4) scale parameter for Inverse-Gamma prior on the inverse variance of the absolute
              magnitudes""")
